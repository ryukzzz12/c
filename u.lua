...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "_id.1"})
    creditsSection:AddText({text = "LyeHub"})
    ...
    mainSection:AddButton({text = 'Copy Discord', flag = 'copydiscord', callback = function()
        setclipboard('https://discord.gg/RtCGurjq88'..getgenv().Config.Invite)
    end})
